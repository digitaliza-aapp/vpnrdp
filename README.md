...
Imagen preparada para trabajar en modo persistente (no es necesario instalar el certificado en cada arranque del sistema), permite el arranque dual MBR (Legacy BIOS) / UEFI y crea una partición para poder almacenar el certificado digital (pfx ó p12 ) y facilitar su instalación
